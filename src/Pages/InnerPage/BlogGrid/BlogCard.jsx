...
const BlogCard = ({blogThumb,thumbDate,thumbMonth,blogUrl,blogTitle,blogDesc,btnContent,btnIcon}) => {
    return (
      <div className="bg-black group transition-all duration-500  hover:shadow-cases rounded-md text-[#02416A]">
        ...
        <div className="px-5 sm:px-7 pb-7">
            ...
            <button className="uppercase font-Inter text-left font-semibold text-xl sm:text-[22px] lg:text-xl xl:text-[22px] text-[#ffffff]  hover:text-[#02416A] mt-7 mb-3">
              {blogTitle}
            </button>
          <p className="font-Poppins font-light text-[#7f7f7f]">{blogDesc}</p>
          {/* <Link to={blogUrl}>
