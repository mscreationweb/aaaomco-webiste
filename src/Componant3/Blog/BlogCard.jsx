    ...
    return (
      <div className="bg-transparent group transition-all duration-500 hover:bg-white hover:shadow-cases rounded-md">
        ...
        <div className="px-5 sm:px-7 pb-8">
          ...
          <Link to={blogUrl}>
            <button className="font-Inter text-start font-bold text-xl sm:text-[22px] lg:text-lg xl:text-xl text-[#02416A] transition-all duration-500 hover:text-[#FD9F00] mt-3 mb-5">
              {blogTitle}
            </button>
          </Link>
