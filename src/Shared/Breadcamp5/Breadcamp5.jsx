...
const Breadcamp5 = ({
  ...
  return (
    <div className="relative h-[400px] sm:h-[450px] text-center pt-20 flex items-center bg-[url('/images/allimg/mainbg/5.jpg')] bg-no-repeat bg-cover bg-center">
  {/* Tint Overlay */}
