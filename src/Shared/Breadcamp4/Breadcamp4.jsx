...
const Breadcamp4 = ({
  ...
  return (
    <div className="bg-[url('/images/allimg/mainbg/4.jpg')] bg-no-repeat bg-cover bg-center flex items-center h-[400px] sm:h-[450px] text-center pt-20">
