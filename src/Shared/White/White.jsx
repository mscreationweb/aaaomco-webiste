...
const White = ({
  ...
  return (
    <div className="bg-[#F5F5F5] bg-no-repeat bg-cover bg-center flex items-center lg:h-[300px] h-[200px] sm:h-[450px] text-center pt-20">
      <div className="Container relative">
        ...
        /> */}
        <h1 className="font-Inter font-bold text-4xl sm:text-[46px] text-[#02416A] capitalize">
          {breadCampTitle}
        </h1>
